#ifndef CAFFE2_CORE_NET_CL_H_
#define CAFFE2_CORE_NET_CL_H_
...
class CLNet : public NetBase {
 ...
 public:
  CLNet(const std::shared_ptr<const NetDef>& net_def, Workspace* ws);
