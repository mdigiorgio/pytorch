...
class ConvRelu : public NeuralNetOperator {
 public:
  ConvRelu(vector<int> kernelShape,
    vector<int> pads = {0, 0},
    vector<int> strides = {1, 1},
    int group = 1,
    vector<int> dilations = {1, 1}) :
...
class AveragePool : public NeuralNetOperator {
 public:
  AveragePool(vector<int> kernelShape,
    vector<int> pads = {0, 0},
    vector<int> strides = {1, 1}) :
...
class AveragePoolRelu : public NeuralNetOperator {
 public:
  AveragePoolRelu(vector<int> kernelShape,
    vector<int> pads = {0, 0},
    vector<int> strides = {1, 1}) :
...
class MaxPool : public NeuralNetOperator {
 public:
  MaxPool(vector<int> kernelShape,
    vector<int> pads = {0, 0},
    vector<int> strides = {1, 1}) :
...
class MaxPoolRelu : public NeuralNetOperator {
 public:
  MaxPoolRelu(vector<int> kernelShape,
    vector<int> pads = {0, 0},
    vector<int> strides = {1, 1}) :
...
class Receive : public NeuralNetOperator {
 public:
  Receive(string source) :
      NeuralNetOperator(NNKind::Receive),
      Source(source) {}
...
class BatchNormalization : public NeuralNetOperator {
 public:
  BatchNormalization(float epsilon = 1e-5f,
    float momentum = 0.9f,
    bool spatial = true,
    bool isTest = false) :
...
class Int8Quantize : public NeuralNetOperator {
 public:
  Int8Quantize() :
      NeuralNetOperator(NNKind::Int8Quantize) {}
...
class Int8Dequantize : public NeuralNetOperator {
 public:
  Int8Dequantize() :
      NeuralNetOperator(NNKind::Int8Dequantize) {}
...
class Int8Conv : public NeuralNetOperator {
 public:
  Int8Conv() :
      NeuralNetOperator(NNKind::Int8Conv) {}
  
  Int8Conv(const Conv& conv) :
      NeuralNetOperator(NNKind::Int8Conv) {}
...
class Int8FC : public NeuralNetOperator {
 public:
  Int8FC() :
      NeuralNetOperator(NNKind::Int8FC) {}
...
class Int8Relu : public NeuralNetOperator {
 public:
  Int8Relu() :
      NeuralNetOperator(NNKind::Int8Relu) {}
  
  Int8Relu(const Relu& relu) :
      NeuralNetOperator(NNKind::Int8Relu) {}
...
class Int8Concat : public NeuralNetOperator {
 public:
  Int8Concat() :
      NeuralNetOperator(NNKind::Int8Concat) {}
  
  Int8Concat(const Concat& concat) :
      NeuralNetOperator(NNKind::Int8Concat) {}
...
class Int8Sum : public NeuralNetOperator {
 public:
  Int8Sum() :
      NeuralNetOperator(NNKind::Int8Sum) {}
  
  Int8Sum(const Sum& sum) :
      NeuralNetOperator(NNKind::Int8Sum) {}
...
class Int8Add : public NeuralNetOperator {
 public:
  Int8Add() :
      NeuralNetOperator(NNKind::Int8Add) {}
  
  Int8Add(const Add& add) :
      NeuralNetOperator(NNKind::Int8Add) {}
